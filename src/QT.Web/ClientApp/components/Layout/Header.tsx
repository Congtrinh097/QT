        ...
        return (
            <div id="header" className="page-navbar">
                <a href="index.html" className="navbar-brand hidden-xs hidden-sm">
                    <img src="/assets_admin/img/logo.png" className="logo hidden-xs" alt="Dynamic logo" />
                    <img src="/assets_admin/img/logosm.png" className="logo-sm hidden-lg hidden-md" alt="Dynamic logo" />
                </a>
                <div id="navbar-no-collapse" className="navbar-no-collapse">
                    <ul className="nav navbar-nav">
                        ...
                        <li>
                            <a href="#" className="reset-layout tipB" title="Reset panel position for this page"><i className="fa fa-history"></i></a>
                        </li>
                    </ul>
                    <ul className="nav navbar-nav navbar-right">
                        <li className="dropdown">
                            ...
                            <ul className="dropdown-menu right dropdown-notification" role="menu">
                                ...
                                <li><a href="#"><i className="l-basic-life-buoy"></i> 2 support request</a>
                                </li>
                                <li><a href="#"><i className="l-basic-gear"></i> Settings is changed</a>
                                </li>
                                <li><a href="#"><i className="l-weather-lightning"></i> 5 min server downtime</a>
                                </li>
                                <li><a href="#"><i className="l-basic-server2"></i> Databse backup is complete</a>
                                </li>
                                <li><a href="#"><i className="l-basic-lightbulb"></i> SuggeElson push 1 commit</a>
                                </li>
                                <li><a href="#" className="view-all">View all <i className="l-arrows-right"></i> </a>
                                </li>
                            </ul>
                        </li>
                        <li className="dropdown">
